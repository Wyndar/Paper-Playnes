...
{
    /// <summary>
    /// A smooth-follow camera controller for the Airplane.
    /// Attach this script to the camera and assign the airplane as the target.
    /// </summary>
    public class CameraController : MonoBehaviour
    {
        ...
        [Header("Dynamic FOV")] [SerializeField]
        ...
        private void AdjustFOV()
        {
            ...
            float targetFOV = target.GetComponent<AirplaneController>() ? boostFOV : baseFOV;
